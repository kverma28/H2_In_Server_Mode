...
ALTER TABLE INSTRUCTOR ADD CONSTRAINT INST_ZIP_FK FOREIGN KEY (ZIP) REFERENCES ZIPCODE (ZIP);

-- Creating Foreign Keys on 'GRADE'
ALTER TABLE GRADE ADD CONSTRAINT GR_ENR_FK FOREIGN KEY (STUDENT_ID,SECTION_ID) REFERENCES ENROLLMENT (STUDENT_ID,SECTION_ID);
ALTER TABLE GRADE ADD CONSTRAINT GR_GRTW_FK FOREIGN KEY (SECTION_ID ,GRADE_TYPE_CODE) REFERENCES GRADE_TYPE_WEIGHT(SECTION_ID,GRADE_TYPE_CODE);
